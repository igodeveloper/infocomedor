...
class Application_Model_Caja extends ZendExt_Db_Table_Row_Abstract {
    ...
    public function setFromArray(array $data) {
    	foreach (array('cod_caja', 'cod_usuario_caja', 'fecha_hora_apertura', 'fecha_hora_cierre', 'monto_caja_apertura', 'monto_caja_cierre', 'monto_diferencia_arqueo', 'arqueo_caja') as  $property) {
