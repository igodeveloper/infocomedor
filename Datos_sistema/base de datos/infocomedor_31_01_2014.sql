...
--
-- Servidor: localhost
-- Tiempo de generación: 31-01-2014 a las 18:22:07
...
CREATE TABLE IF NOT EXISTS `karrito` (
  `COD_KARRITO` int(11) NOT NULL,
  `KAR_FECH_MOV` date NOT NULL,
  `KAR_MES` int(11) NOT NULL,
  `KAR_AÑO` int(11) NOT NULL,
  `COD_CLIENTE` int(11) NOT NULL,
  `COD_MESA` int(11) NOT NULL,
  `COD_PRODUCTO` int(11) NOT NULL,
  `KAR_CANT_PRODUCTO` int(11) NOT NULL,
  `COD_ESTADO_PEDIDO` int(11) NOT NULL,
  `KAR_COD_TIPO_PEDIDO` int(11) NOT NULL,
  `COD_MOZO` int(11) NOT NULL,
  `FACT_NRO` char(1) NOT NULL,
  `COD_UNIDAD_MEDIDA` int(11) NOT NULL,
