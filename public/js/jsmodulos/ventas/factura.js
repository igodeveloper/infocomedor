...
function obtenerGrid() {
    ...
    if (dataObjectVenta.codcliente === "" || dataObjectVenta.codcliente === null) {
        mostarVentana("warning", "Ingrese el Codigo del cliente");
    } else if ($('#controlfiscal-modal_3').attr("value") === "") {
        mostarVentana("warning", "Ingrese el control fiscal");
    } else if (dataObjectVentaDetalle.length < 1) {
        mostarVentana("warning", "Ingrese al menos un producto para la venta");
    } else {
