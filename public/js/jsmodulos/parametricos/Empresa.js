...
mensajeWarning = new Array(
		...
		" |  Tel\u00e9fono ",
		" |  Nombre del contacto ");
idCamposGrilla = new Array("id-registro","descripcionBusqueda-modal","ruc-modal","direccion-modal","telefono-modal","nombrecontacto-modal");
...
function obtenerJsonFormulario() {
    ...
    if (mensaje == 'Complete los campos:') {
        ...
        jsonObject.descripcionEmpresa = $('#'+idCamposGrilla[1]).attr("value");
        jsonObject.rucEmpresa = $('#'+idCamposGrilla[2]).attr("value");
        jsonObject.direccionEmpresa = $('#'+idCamposGrilla[3]).attr("value");
        jsonObject.telefonoEmpresa = $('#'+idCamposGrilla[4]).attr("value");
        jsonObject.nombrecontactoEmpresa = $('#'+idCamposGrilla[5]).attr("value");
        return jsonObject;
    }else {
...
function editarRegistro(parametros){
	...
	$("#"+idCamposGrilla[1]).attr("value",parametros.descripcionEmpresa);
	$("#"+idCamposGrilla[2]).attr("value",parametros.rucEmpresa);
	$("#"+idCamposGrilla[3]).attr("value",parametros.direccionEmpresa);
        $("#"+idCamposGrilla[4]).attr("value",parametros.telefonoEmpresa);
        $("#"+idCamposGrilla[5]).attr("value",parametros.nombrecontactoEmpresa);
