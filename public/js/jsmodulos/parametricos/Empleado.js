table = "/parametricos/Empleado/";
mensajeWarning = new Array("Complete el Nombre por favor","Complete el Apellido por favor","Complete el Nro de documento por favor","Complete la direccion por favor","Complete el teledono por favor");
idCamposGrilla = new Array("id-registro","descripcionBusqueda-modal","apellido-modal","documento-modal","direccion-modal","telefono-modal");
...
function obtenerJsonFormulario() {
	...
	if($('#'+idCamposGrilla[1]).attr("value") == null || $('#'+idCamposGrilla[1]).attr("value").length == 0){
		...
		jsonObject.idRegistro = $('#'+idCamposGrilla[0]).attr("value");
                jsonObject.nombreEmpleado = $('#'+idCamposGrilla[1]).attr("value");
                jsonObject.apellidoEmpleado = $('#'+idCamposGrilla[2]).attr("value");
                jsonObject.documentoEmpleado = $('#'+idCamposGrilla[3]).attr("value");
                jsonObject.direccionEmpleado = $('#'+idCamposGrilla[4]).attr("value");
                jsonObject.telefonoEmpleado = $('#'+idCamposGrilla[5]).attr("value");
		return jsonObject;
	}
    return null;
}
...
function editarRegistro(parametros){
	...
	$("#"+idCamposGrilla[1]).attr("value",parametros.nombreEmpleado);
	$("#"+idCamposGrilla[2]).attr("value",parametros.apellidoEmpleado);
	$("#"+idCamposGrilla[3]).attr("value",parametros.documentoEmpleado);
        $("#"+idCamposGrilla[4]).attr("value",parametros.direccionEmpleado);
        $("#"+idCamposGrilla[5]).attr("value",parametros.telefonoEmpleado);
...
function obtenerJsonBuscar(){
	var jsonObject = new Object();
        alert("valor :"+$('#descripcionBusqueda').attr("value"));
