...
function obtenerJsonFormulario() {
	...
	if($('#'+idCamposGrilla[1]).attr("value") == null || $('#'+idCamposGrilla[1]).attr("value").length == 0){
		...
		jsonObject.idRegistro = $('#'+idCamposGrilla[0]).attr("value");
                jsonObject.descripcionSucursal= $('#'+idCamposGrilla[1]).attr("value");
                jsonObject.direccionSucursal= $('#'+idCamposGrilla[2]).attr("value");
                jsonObject.telefonoSucursal= $('#'+idCamposGrilla[3]).attr("value");
                jsonObject.nombrecontactoSucursal= $('#'+idCamposGrilla[4]).attr("value");
		return jsonObject;
	}
    return null;
}
...
function editarRegistro(parametros){
	...
	$("#"+idCamposGrilla[1]).attr("value",parametros.descripcionSucursal);
	$("#"+idCamposGrilla[2]).attr("value",parametros.direccionSucursal);
        $("#"+idCamposGrilla[3]).attr("value",parametros.telefonoSucursal);
        $("#"+idCamposGrilla[4]).attr("value",parametros.nombrecontactoSucursal);
