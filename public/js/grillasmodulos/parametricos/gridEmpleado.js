...
campos = new Array('Nombre','Apellido','Documento','Direccion','Telefono');
camposId = new Array('NombreId','ApellidoId','DocumentoId','DireccionId','TelefonoId');
...
function cargarLinkModificar ( cellvalue, options, rowObject )
{
	...
	parametros.nombreEmpleado = rowObject[2];
	parametros.apellidoEmpleado = rowObject[3];
	parametros.documentoEmpleado = rowObject[4];
        parametros.direccionEmpleado = rowObject[5];
        parametros.telefonoEmpleado = rowObject[6];
