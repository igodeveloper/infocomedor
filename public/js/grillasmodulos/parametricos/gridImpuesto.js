...
campos = new Array('Descripci&oacuten', 'Sigla','Porcentaje');
camposId = new Array('descripcionID', 'siglaImpuestoId','porcentajeImpuestoId');
...
function cargarLinkModificar ( cellvalue, options, rowObject )
{
	...
	parametros.descripcionImpuesto = rowObject[2];
	parametros.siglaImpuesto = rowObject[3];
        parametros.porcentajeImpuesto = rowObject[4];
