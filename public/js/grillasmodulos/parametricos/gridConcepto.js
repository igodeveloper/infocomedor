...
campos = new Array('Descripci&oacuten', 'Accion');
camposId = new Array('descripcionID', 'accionConceptoId');
...
function cargarLinkModificar ( cellvalue, options, rowObject )
{
	...
	parametros.descripcionConcepto= rowObject[2];
	parametros.accionConcepto= rowObject[3];
