...
campos = new Array('Descripci&oacuten', 'Sigla Forma Pago');
camposId = new Array('descripcionID', 'isoFormaPagoId');
...
function cargarLinkModificar ( cellvalue, options, rowObject )
{
	...
	parametros.descripcionFormaPago = rowObject[2];
	parametros.isoFormaPago = rowObject[3];
