...
var table = pathname;
campos = new Array('DESCRIPCION', 'RUC','DIRECCION');
camposId = new Array('DescripcionId', 'RUCId','DireccionId');
...
function cargarLinkModificar ( cellvalue, options, rowObject )
{
	...
	parametros.descripcionEmpresa = rowObject[2];
	parametros.rucEmpresa = rowObject[3];
	parametros.direccionEmpresa = rowObject[4];
        parametros.telefonoEmpresa = rowObject[5];
        parametros.nombrecontactoEmpresa = rowObject[6];       
