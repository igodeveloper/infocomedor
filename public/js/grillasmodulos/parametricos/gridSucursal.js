...
var table = pathname;
campos = new Array('Id','Descripci&oacuten','Direccion','Telefono');
camposId = new Array('Id','DescripcionId','DireccionId','TelefonoId');
...
function cargarLinkModificar ( cellvalue, options, rowObject )
{
	...
	parametros.descripcionSucursal= rowObject[2];
	
	parametros.direccionSucursal= rowObject[3];
        parametros.telefonoSucursal= rowObject[4];
        parametros.nombrecontactoSucursal= rowObject[5];
