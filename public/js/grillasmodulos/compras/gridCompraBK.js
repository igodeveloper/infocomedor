agrupamientoGrids = "";
primeraVez = true; // prueba de svn
table = "/compras/compra/";
campos = new Array('Sucursal', 'Proveedor','Nro. Factura','Fecha Emisi&oacute;n','Fecha Vencimiento','Monto Compra','Moneda','Credito');
camposId = new Array('sucursal', 'proveedor','Nro_Factura','Fecha_Emision','Fecha_Vencimiento','Monto_Compra','Moneda','Credito');
	        ...
	        success: function(data){
	        	if(data.result == "ERROR"){
                                if(data.mensaje == 23504) {
                                        ...
                                        mostarVentana("warning-registro-listado","No se puede eliminar el Registro por que ha sido transferido");
			        }
                                else {
...
function cargarLinkModificar ( cellvalue, options, rowObject )
{
	...
	parametros.descripcion = rowObject[2];
	parametros.tipoInsumo = rowObject[3];
        parametros.idTipoInsumo = rowObject[4];
