<?php
  ...
  //require(PATH_FPDF.'fpdf.php');
	error_reporting(0);
    class PDFReporteinventarioajuste extends FPDF
    {  
            var $Conn;
            var $parametros;
            var $B;
            ...
            function PDFReporteinventarioajuste($orientation='P',$unit='mm',$format='A4',$parametrosPDF)
            {
        ...
        {          
                ...
                $sql = "select x.COD_INVENTARIO from inventario x
                        WHERE x.COD_INVENTARIO = ".$this->parametros;
                ...
                $fila1 = mysql_fetch_row($dtDatos);
                 ...
                 $sql2= "select 
                        ...
                        a.COD_PRODUCTO, 
                        b.PRODUCTO_DESC, 
                        a.INVENTARIO_ENTRADA, 
                        a.INVENTARIO_SALIDA, 
                        a.INVENTARIO_SALDO, 
                        b.COD_UNIDAD_MEDIDA, 
                        c.ISO_UNIDAD_MEDIDA
                        FROM inventario a
                        JOIN producto b ON a.COD_PRODUCTO = b.COD_PRODUCTO
                        JOIN unidad_medida c ON b.COD_UNIDAD_MEDIDA = c.COD_UNIDAD_MEDIDA
                        WHERE a.COD_INVENTARIO = ".$this->parametros."
            ...
            $this->SetX(80+$x);
            $this->Cell(80,10,utf8_decode("Listado Ajuste Inventario"),0,0,'L');
            ...
            $this->Ln(10);//Salto de l�nea   
             $this->SetFont('Arial','',9);
            $this->Cell(80,10,'Cod Inventario: '.$fila1[0],0,0,'L'); 
             $this->Ln(10);//Salto de l�nea 
                ...
                $this->SetX(80);
                $this->Cell(18,10,'Existencia',0,0,'L');
                $this->SetX(110);
                $this->Cell(25,10,'Inventario',0,0,'L');
                $this->SetX(150);
                $this->Cell(25,10,'Diferencia',0,0,'L');
                 $this->SetX(180);
                ...
                {   
                    ...
                    $INVENTARIO_ENTRADA = $row2["INVENTARIO_ENTRADA"];
                    $INVENTARIO_SALIDA = $row2["INVENTARIO_SALIDA"];
                    $INVENTARIO_SALDO = $row2["INVENTARIO_SALDO"];
                ...
                $this->SetX(80);
                $this->Cell(18,10, $INVENTARIO_ENTRADA ,0,0,'L');
                $this->SetX(110);
                $this->Cell(25,10,$INVENTARIO_SALIDA,0,0,'L');
                $this->SetX(150);
                $this->Cell(25,10, $INVENTARIO_SALDO,0,0,'L');
                 $this->SetX(180);
